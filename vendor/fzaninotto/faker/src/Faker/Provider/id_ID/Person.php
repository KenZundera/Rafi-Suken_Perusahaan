...
class Person extends \Faker\Provider\Person
{
    ...
    protected static $gender = ['L', 'P'];

    protected static $nik = [
        // make 1 and then random number between 0 and 9
        '1' => [
            '0' => '0',
            '1' => '1',
            '2' => '2',
    ...
    {
        return static::randomElement(static::$religion);
    }
    ...
    {
        return static::randomElement(static::$nik);
    }
}
